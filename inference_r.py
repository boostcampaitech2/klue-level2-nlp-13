...
def main(args):
  ...
  ## load my model
  MODEL_NAME = './best_model/random-seed_roberta-large_batch_16' # model dir.
  ...
  output.to_csv('./prediction/submission_siaun.csv', index=False) # 최종적으로 완성된 예측한 라벨 csv 파일 형태로 저장.
  #### 필수!! ##############################################
  print('---- Finish! ----')
if __name__ == '__main__':
  ...
  # model dir
  parser.add_argument('--model_dir', type=str, default="./best_model/random-seed_roberta-large_batch_16")
